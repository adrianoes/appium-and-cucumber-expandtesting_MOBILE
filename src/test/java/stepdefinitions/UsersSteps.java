...
//    }
    ...
    public void user_sends_request_to_create_user() {
        ...
        // Selecionar POST
        wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("com.ab.apiclient:id/spHttpMethod")));
    ...
    public void user_should_see_invalid_email_message() throws IOException {
        ...
        assertEquals("A valid email address is required'", "A valid email address is required", message);
    }
    ...
    public void user_should_see_login_with_invalid_password_message() {
        ...
        assertEquals("Incorrect email address or password'", "Incorrect email address or password", message);
    }
...
//    }
    ...
    public void user_sends_request_to_updates_user_info_with_invalid_username() {
        ...
        //fill form in raw code
        WebElement jsonDataField = wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("com.ab.apiclient:id/etJSONData")));
        String formData = "name=" + "a@#" + "&phone=" + user_phone + "&company=" + user_company;
        jsonDataField.sendKeys(formData);
    ...
    public void user_should_see_invalid_username_message() {
        ...
        assertFalse("Success should be false", success);
        assertEquals("Status should be 400", 400, status);
        assertEquals("Message should be 'User name must be between 4 and 30 characters'", "User name must be between 4 and 30 characters", message);
    }
    ...
    public void user_sends_request_to_update_a_short_password() {
        ...
        //fill form in raw code
        WebElement jsonDataField = wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.id("com.ab.apiclient:id/etJSONData")));
        String formData = "currentPassword=" + user_password + "&newPassword=" + "123";
        jsonDataField.sendKeys(formData);
    ...
    public void user_should_receive_short_password_message() {
        ...
        assertFalse("Success should be false", success);
        assertEquals("Status should be 400", 400, status);
        assertEquals("Message should be 'New password must be between 6 and 30 characters'", "New password must be between 6 and 30 characters", message);
    }
